...
- **vendor.x_special@outlook.com** - Vendor X & Co.
- **vendor.y_special@outlook.com** - Vendor Y (Special) Ltd.
- **vendor.z_special@outlook.com** - Vendor Z "Quality" Inc.
...
#### For Scenario E (Multiple 9COMs)
```
First 9COM (890-123456) - Document ID: 1SBfkN_uDqgVHRP32BrWRpPbznA8cuQ0_
Contains: Multi-Item Vendors M, N, O

Second 9COM (123-456789) - Document ID: 1HdUcnznBm57-kVN5_TfFYzEX-bpCgcpJ
Contains: Piping Vendors P, Q
```

#### For Scenario F (9COM: 567-890123 - special characters test)
```
9COM_Number | Vendor_Name           | Vendor_Email                  | AVL_Document_ID
567-890123  | Vendor X & Co.        | vendor.x_special@outlook.com  | [create new]
567-890123  | Vendor Y (Special) Ltd| vendor.y_special@outlook.com  | [create new]
567-890123  | Vendor Z "Quality" Inc| vendor.z_special@outlook.com  | [create new]
```
...
Scenario E: vendor.m_multi@outlook.com, vendor.n_multi@outlook.com, vendor.o_multi@outlook.com, vendor.p_pipe@outlook.com, vendor.q_pipe@outlook.com
Scenario F: vendor.x_special@outlook.com, vendor.y_special@outlook.com, vendor.z_special@outlook.com
...
- Scenario E: vendor.m_multi, vendor.n_multi, vendor.o_multi, vendor.p_pipe, vendor.q_pipe (Outlook)
- Scenario F: vendor.x_special, vendor.y_special, vendor.z_special (Outlook)
